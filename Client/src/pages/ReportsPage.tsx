    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-neutral-600">Generate and export system data.</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Full Export Card */}
        <div className="rounded-xl border border-neutral-300 bg-white p-6 shadow-lg flex flex-col items-start gap-4">
          <div className="rounded-lg bg-red-50 p-3 text-red-600">
            <FileText className="h-6 w-6" />
          </div>
          <div>
            <h3 className="text-lg font-semibold text-neutral-900">Full Asset Export</h3>
            <p className="mt-1 text-sm text-neutral-600">Download a complete CSV of all assets currently in the system, including their statuses and locations.</p>
          </div>
        ...
        {/* Quick Stats Summary */}
        <div className="rounded-xl border border-neutral-300 bg-white p-6 shadow-lg flex flex-col items-start gap-4 col-span-1 md:col-span-2">
          ...
          {stats ? (
            <div className="mt-2 w-full grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <div className="rounded-lg bg-neutral-50 p-4 border border-neutral-200">
                <div className="text-sm text-neutral-600">In Maintenance</div>
